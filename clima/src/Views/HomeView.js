...
class GetApi extends Component{
    ...
    async componentDidMount(){
        ...
        const access_key = `295b72e6d7a938836f057ff48092f037`;
    ...
    render(){
        ...
        if(!this.state.weather || this.state.weather.error){
            return (
                <div style={{background: `linear-gradient(#74b9ff, #00cec9)`, position: 'absolute', top: 0, right: 0, bottom: 0, left: 0}}>
                <div style={{display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '0em', position: 'absolute', top: '10%', left: '30%', color: '#dfe6e9'}}>
                <img src="https://cdn.dribbble.com/users/20580/screenshots/1276530/artisan-errors.gif" style={{ fontSize: '10px'}}/>
                </div>
            </div>
            )
        }
        return (
            <div style={{background: `linear-gradient(#74b9ff, #00cec9)`, position: 'absolute', top: 0, right: 0, bottom: 0, left: 0}}>
                <div style={{display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '0em', position: 'absolute', top: '10%', left: '42%'}}>
